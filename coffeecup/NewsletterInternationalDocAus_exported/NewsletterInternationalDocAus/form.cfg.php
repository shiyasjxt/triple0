...
"settings":
{
	"data_settings" : 
	{
		...
		"save_sqlite" : 
		{
			"database" : "NewsletterInternationalDocAus.dat",
			"is_present" : false,
			"tablename" : "NewsletterInternationalDocAus"
		}
	},
	"email_settings" : 
	{
	...
	"mailchimp" : 
	{
		"apiKey" : "75775756c32af16be11fb6c4e0d723c7-us10",
		"lists" : 
		[
			
			{
				...
				"name" : "International Doctors - Australia",
				"subscribe" : 
				{
					"double_optin" : true,
	...
	"redirect_settings" : 
	{
		...
		"gotopage" : "",
		"inline" : "<center>\n<style type=\"text/css\">\n#docContainer table {margin-top: 30px; margin-bottom: 30px; width:80%;}\n#docContainer td {font-size: 12px !important; line-height: 30px;color: #666666 !important; margin: 0px;border-bottom: 1px solid #e9e9e9;}\n#docContainer td:first-child {font-size: 13px !important; font-weight:bold; color: #333 !important; vertical-align:text-top; min-width:50%; padding-right:5px;}\n</style>\n<h2>Thank you!</h2><br/>\n<p>Thank you for signing up to our Australian Doctor Opportunities newsletter, we look forward to you being part of our community.</p>\n</center>",
		"type" : "inline"
	},
	"uid" : "456a958d1a3491144367afc23d53875a",
	"validation_report" : "in_line"
},
"rules":{"firstname":{"label":"FIRST NAME *","fieldtype":"text","required":true,"messages":"This is a required field"},"lastname":{"label":"LAST NAME *","fieldtype":"text","required":true,"messages":"This is a required field"},"email":{"email":true,"label":"EMAIL ADDRESS *","fieldtype":"email","required":true,"messages":"This is a required field"}},
"payment_rules":{},
"conditional_rules":{},
